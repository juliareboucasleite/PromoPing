...
// Validação do formato da versão (vX.X.X ou vX.X.X-nome)
...
console.log(`Iniciando processo de release para ${versionArg}...\n`);
...
execSync(`git commit -m "chore(release): update to ${versionArg}"`, { stdio: "inherit" });
...
// 4. Criar release via API do GitHub
