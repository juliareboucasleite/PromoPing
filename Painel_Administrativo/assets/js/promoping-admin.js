(function(w) {
    async function detectApiBase() {
        ...
        try {
            const r = await fetch(`${phpApiBase}/api/status.php`, {
                method: 'GET'
            });
            if (r.ok) {
    ...
    const initApiBasePromise = detectApiBase().then(b => {
        API_BASE_GLOBAL = b;
        return b;
    });
    ...
    async function fetchJSON(path, opts = {}) {
        ...
        const resp = await fetch(`${apiBase}${fullPath}`, Object.assign({}, opts, {
            headers
        }));
        ...
        try {
            ...
            if (profileAvatar) {
                ...
                profileAvatar.onerror = function() {
                    // Usar avatar padrão local do PromoPing
                    this.src = '../assets/img/promoping/PromoPing.png';
                };
            }
    ...
    async function saveProfile() {
        ...
        try {
            console.log('[Profile] Salvando perfil...', {
                nome,
                email,
                telefone
            });
    ...
    async function initConversations() {
        ...
        <li class="list-group-item border-0 d-flex align-items-center px-0 mb-2 conversation-item" 
          ...
          <div class="avatar me-3 position-relative">
            ...
            ` : `
              <img src="../assets/img/promoping/PromoPing.png" alt="avatar" class="border-radius-lg shadow" style="width: 40px; height: 40px;">
            `}
    ...
    function renderMessageAdmin(msg) {
      ...
      <div class="message-item d-flex justify-content-${isUser ? 'start' : 'end'} mb-4 align-items-end" style="gap: 10px;">
        ...
        ${!isUser ? `
          <img src="../assets/img/promoping/PromoPing.png" alt="suporte" 
