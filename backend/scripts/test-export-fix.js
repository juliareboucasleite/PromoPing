...
async function testarCorrecoes() {
  ...
  try {
    ...
    console.log("2️⃣ Verificando tabela historicoprecos...");
    ...
    if (tabelas[0].total > 0) {
      ...
      console.log("4️⃣ Verificando dados na tabela...");
      ...
      if (dados[0].total > 0) {
        ...
        console.log("5️⃣ Testando query de histórico...");
    ...
    console.log("6️⃣ Verificando tabela configutilizador...");
    ...
    if (config[0].total > 0) {
      ...
      console.log("7️⃣ Verificando dados de usuário...");
    ...
    console.log("8️⃣ Verificando tabela planos...");
